...
Oldest → newest, last N runs (`-n`, default 10). The log file keeps the last 50 runs. With no history: `{"version": "2.13.0", "runs": [], "disk_history": {...}}` (`disk_history` is present either way).
