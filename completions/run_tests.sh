...
eq "targets 1st value"    "93" "$(B 'maccleaner clean --targets ' | wc -l | tr -d ' ')"
eq "targets 2nd value"    "92" "$(B 'maccleaner clean --targets npm-cache,' | wc -l | tr -d ' ')"
eq "targets 3rd value"    "91" "$(B 'maccleaner clean --targets npm-cache,pip-cache,' | wc -l | tr -d ' ')"
...
eq "alias mclean --targets" "93" "$(B 'mclean --targets ' | wc -l | tr -d ' ')"
...
eq "zsh targets 1st"      "93" "$(Z 'maccleaner clean --targets ' | wc -l | tr -d ' ')"
eq "zsh targets 2nd"      "92" "$(Z 'maccleaner clean --targets npm-cache,' | wc -l | tr -d ' ')"
eq "zsh targets 3rd"      "91" "$(Z 'maccleaner clean --targets npm-cache,pip-cache,' | wc -l | tr -d ' ')"
...
eq "zsh alias mclean --targets (multi-word tail)" \
   "92" "$(Z 'mclean --targets npm-cache,' | wc -l | tr -d ' ')"
eq "zsh alias mclean --yes --targets (3-word tail)" \
   "92" "$(Z 'mclean --yes --targets npm-cache,' | wc -l | tr -d ' ')"
eq "zsh non-alias parity for the same case" \
   "92" "$(Z 'maccleaner clean --targets npm-cache,' | wc -l | tr -d ' ')"
...
# The live target count has a static floor of 93 (v2.10) but the `logs`
...
ge "real engine bash: --targets count reaches the static floor" \
   "93" "$(RB 'maccleaner clean --targets ' | wc -l | tr -d ' ')"
...
ge "real engine zsh: --targets count reaches the static floor" \
   "93" "$(RZ 'maccleaner clean --targets ' | wc -l | tr -d ' ')"
